...
class List:
    ...
    def combine(self, source1, source2):
        ...
        while len(source1._values) > 0 and len(source2._values) > 0:
            self._values += [source1.pop(0)]
            self._values += [source2.pop(0)]
        ...
        for element1 in source1:
            for element2 in source2:
                if element1 == element2:
                    i = self._linear_search(element1)
                    if i == -1:
    ...
    def union(self, source1, source2):
        ...
        i = 0
        while i < len(source1):
            if self._linear_search(source1._values[i]) == -1:
                self._values += [source1._values[i]]
            i += 1
        
        i = 0
        while i < len(source2):
            if self._linear_search(source2._values[i]) == -1:
