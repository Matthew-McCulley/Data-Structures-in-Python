...
class Queue:
    ...
    def insert(self, value):
        ...
        #if it is empty, the front will be the current rear
        if self.is_empty():
            self._front = self._rear
        
        self._values[self._rear] = deepcopy(value)
        
        #increasing count before shifting the rear
        self._count += 1
        
        #shifting the rear up 1
        if self._rear == len(self._values) - 1:
            self._rear = None
        else:
