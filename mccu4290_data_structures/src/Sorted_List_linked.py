...
class Sorted_List:
    ...
    def _is_valid_index(self, i):
        ...
        if i < 0:
            i += self._count -1
        return -self._count < i or i < self._count - 1
    ...
    def clean(self):
        ...
        while curr is not None:
            if prev is not None and prev._value == curr._value:
                prev._next = curr._next 
            else:
                prev = curr 
            curr = curr._next
    ...
    def intersection(self, source1, source2):
        ...
        while curr1 is not None:
            #check to see if element is in source 2
            _,curr2,_ = source2._linear_search(curr1._value)
            if curr2 is not None:
                #if the element is in both sources
                _,curr,_ = self._linear_search(curr2._value)
                if curr is None:
                    #if value is not in list yet
    ...
    def union(self, source1, source2):
        ...
        curr1 =source1._front 
        while curr1 is not None:
            #checking to see if element is already in list
            _,curr,_ = self._linear_search(curr1._value)
            if curr is None:
    ...
    def is_identical(self, other):
        ...
        identical = True 
        curr = self._front
        curr_other = self._front 
        if self._count != other._count:
            identical = False 
        else:
            while curr is not None and identical:
                if curr._value != curr_other._value:
                    identical = False
                curr = curr._next 
                curr_other = curr_other._next
        return identical
